...
public class pinchange extends JFrame implements ActionListener {
    ...
    pinchange(String pinnumber) {
        ...
        pintext.setBounds(170, 300, 400, 20);
        image.add(pintext);
        ...
        reenter.setBounds(170, 340, 180, 20);
        image.add(reenter);

         repin = new JPasswordField();
        repin.setFont(new Font("Ralewaay", Font.BOLD, 20));
        repin.setBounds(330, 340,180, 20);
        image.add(repin);

         change = new JButton("Change");
        change.setBounds(355, 450, 150, 25);
        change.addActionListener(this);
        image.add(change);

         back = new JButton("Back");
        back.setBounds(355, 480, 150, 25);
